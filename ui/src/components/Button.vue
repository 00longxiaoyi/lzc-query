...
const submitHandle = () => {
  ...
  submitLoading.value = props.submitEvnt()
}
...
<template>
  <div class="button-con">
    <button class="button" :disabled="!props.enabel" @click="submitHandle">
      <span>{{ props.text }}</span>
      <svg v-if="props.isShowLoadingIcon && submitLoading" t="1761311669146" class="icon" viewBox="0 0 1024 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4708" width="15" height="15">
        <path
